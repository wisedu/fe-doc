...
const EmapmInitMobile = resolve => require(['./markdown/mobile/emapm-init.md'], resolve)
const EmapmUploadImgsMobile = resolve => require(['./markdown/mobile/emapm-upload-imgs.md'], resolve)
...
const CssUtilsPc = resolve => require(['./markdown/pc/css-utils.md'], resolve)
const LayoutTmbPc = resolve => require(['./markdown/pc/layout-tmb.md'], resolve)
const PortalsApiPc = resolve => require(['./markdown/pc/portals-api.md'], resolve)
const PortalsDevPc = resolve => require(['./markdown/pc/portals-dev.md'], resolve)
...
Vue.component('layout-tmb-pc', LayoutTmbPc);
