...
const CssCenterPc = resolve => require(['./markdown/pc/css-center.md'], resolve)
const CssFontPc = resolve => require(['./markdown/pc/css-font.md'], resolve)
...
Vue.component('css-center-pc', CssCenterPc);
Vue.component('css-font-pc', CssFontPc);
